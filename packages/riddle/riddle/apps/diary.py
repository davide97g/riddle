...
from riddle.device import notebook
from riddle.ink import render
from riddle.ink.geometry import SCREEN_H, SCREEN_W
from riddle.device import pages
from riddle.mind.memory import Memory
from riddle.device import Device, PenUp, Sample, Tool, Touch
...
class Session:
    def __init__(self) -> None:
        ...
        self.memory = Memory(paths.MEMORIES)
        self.diary = Diary(
    ...
    def _answer(self) -> None:
        ...
        image = render.strokes_to_png(
            written, paths.CAPTURES / f"page-{int(time.time())}-{self.turn}.png"
        )
